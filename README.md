...
### Initialize [Render](https://github.com/itech-eng/render)

```go
import "github.com/itech-eng/render"
...
1. The template name. In this example [Render](https://github.com/itech-eng/render) will look up template `index.tmpl` from view paths. the default view path is `{current_repo_path}/app/views`, and you could register more view paths.
...
[Render](https://github.com/itech-eng/render) will find the layout at `{current_repo_path}/app/views/layouts/new_layout.tmpl`.

### Render with helper functions

Sometimes you may want to have some helper functions in your template. [Render](https://github.com/itech-eng/render) supports passing helper functions by `Funcs` function.
...
Put the [Render](https://github.com/itech-eng/render) inside [Responder](./responder.md) handle function like this.
